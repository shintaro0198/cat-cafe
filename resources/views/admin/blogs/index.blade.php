    ...
    <div class="mb-6 py-4 bg-white rounded">
        ...
        <div class="pt-4 px-4 overflow-x-auto">
            <table class="table-auto w-full">
                ...
                <tr @class(['text-sm', 'bg-gray-50' => $loop->odd]) class="text-sm bg-gray-50">
                    <td class="flex px-4 py-3 items-center">
                        <img class="w-12 h-12 mr-4 object-cover rounded-md" src="{{asset('storage/'.$blog->image)}}" alt="{{route('admin.blogs.edit', ['blog' => $blog->id])}}">
